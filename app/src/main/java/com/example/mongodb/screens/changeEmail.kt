...
fun changeE(navController: NavController) {
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { androidx.compose.material.Text("Cambiar Email", style = MaterialTheme.typography.titleLarge, color = MaterialTheme.colorScheme.onPrimary) },
        ...
        LazyColumn(
            ...
            item {
                Text("Nuevo Email:", style = MaterialTheme.typography.titleMedium, color = MaterialTheme.colorScheme.onSurface)
                Spacer(modifier = Modifier.height(8.dp))
                Box{
                    TextField(
                        value = newEmail,
                        onValueChange = { if (it.length <= 100) newEmail = it },
                        modifier = Modifier
                            .fillMaxWidth()
                            .height(60.dp)
                ...
                Box{
                    TextField(
                        ...
                        onValueChange = { if (it.length <= 100) newConfirmEmail = it },
                        modifier = Modifier
                            .fillMaxWidth()
                            .height(60.dp)
                            .background(MaterialTheme.colorScheme.surface),
                    ...
                    Row(
                        ...
                        androidx.compose.material.Text(
                            text = "${newConfirmEmail.length} / 100",
                            color = MaterialTheme.colorScheme.onPrimary
                        )
                    }
